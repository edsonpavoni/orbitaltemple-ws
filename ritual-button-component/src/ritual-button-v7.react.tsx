...
import { RitualButtonV7 } from './ritual-button-v7.js';
 ...
 */
export default function RitualButtonV7React(props: RitualButtonReactProps) {
  const containerRef = useRef<HTMLDivElement>(null);
  const instanceRef = useRef<RitualButtonV7 | null>(null);
  ...
  useEffect(() => {
    ...
    // Create instance
    const instance = new RitualButtonV7(nativeProps);
