...
interface RitualButtonV7Props extends RitualButtonProps {
...
export class RitualButtonV7 {
  ...
  constructor(props: RitualButtonV7Props = {}) {
  ...
  private createButton(): HTMLButtonElement {
    ...
    button.className = 'ritual-btn-v7';
    button.type = 'button';
  ...
  public update(partialProps: Partial<RitualButtonV7Props>): void {
    ...
    if (partialProps.label !== undefined) {
      const label = this.main.querySelector('.ritual-label-v7');
      if (label) {
        label.textContent = this.props.label;
      }
    }
