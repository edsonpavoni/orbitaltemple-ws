// Shared i18n configuration for both Astro (server) and client-side
// This file should have no runtime dependencies so it can be imported by astro.config.mjs
...
export const SUPPORTED_LANGUAGES: SupportedLanguage[] = [
  ...
  { code: 'br', name: 'Portuguese (Brazil)', nativeName: 'Português Brasileiro'},
...
// Extract just the language codes for Astro config
...
export function isRTL(code: string): boolean {
  return RTL_LANGUAGE_CODES.includes(code);
}
